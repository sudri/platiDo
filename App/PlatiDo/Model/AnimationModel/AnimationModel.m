...
static NSTimeInterval const ShakeDefaultDuration = 0.5;
static NSString * const AnimationKey = @"ShakeAnimationKey";
...
- (void)shakeTF
{
    [self shakeWithDurationTF:ShakeDefaultDuration completion:nil];
}


- (void)shakeWithDurationTF:(NSTimeInterval)duration completion:(void (^)())completion {
